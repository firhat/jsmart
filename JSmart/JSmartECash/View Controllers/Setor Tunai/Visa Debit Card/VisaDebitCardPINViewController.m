//
//  VisaDebitCardPINViewController.m
//  JSmart
//
...
#import "VisaDebitCardPINViewController.h"

@interface VisaDebitCardPINViewController ()

@end

@implementation VisaDebitCardPINViewController
...
- (IBAction)submit:(UIButton *)sender {
    if (![self validateForm]) {
        NSString* message = @"Mohon untuk melengkapi PIN dengan benar.";
        [Helpers alertFailure:message viewController:self];
    }
    //TODO: Process PIN
    [self performSegueWithIdentifier:@"VisaDebitCardSuccess" sender:self];
}
