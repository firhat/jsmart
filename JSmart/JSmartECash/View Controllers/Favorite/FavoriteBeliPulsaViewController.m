//
//  FavoriteBeliPulsaViewController.m
//  JSmart
//
...
#import "FavoriteBeliPulsaViewController.h"

@interface FavoriteBeliPulsaViewController ()

@end

@implementation FavoriteBeliPulsaViewController
