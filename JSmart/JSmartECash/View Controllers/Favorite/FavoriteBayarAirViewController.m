//
//  FavoriteBayarAirViewController.m
//  JSmart
//
...
#import "FavoriteBayarAirViewController.h"

@interface FavoriteBayarAirViewController ()

@end

@implementation FavoriteBayarAirViewController
