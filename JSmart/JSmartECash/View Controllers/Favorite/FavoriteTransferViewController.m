//
//  FavoriteTransferViewController.m
//  JSmart
//
...
#import "FavoriteTransferViewController.h"

@interface FavoriteTransferViewController ()

@end

@implementation FavoriteTransferViewController
